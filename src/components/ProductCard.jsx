...
function ProductCard({ product, onProductClick }) {
  ...
  return (
    <div
      className="bg-white rounded-lg shadow-md hover:shadow-lg transition overflow-hidden h-full flex flex-col cursor-pointer"
    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <h3 className="font-semibold text-sm line-clamp-2 my-2 h-10">{product.title}</h3>
        ...
        <button
          onClick={(e) => {
            e.stopPropagation(); // prevents opening detail when clicking Add
            addToCart(product);
          }}
