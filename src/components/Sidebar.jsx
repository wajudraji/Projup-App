...
function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`bg-white p-4 rounded-lg h-fit fixed md:relative top-0 left-0 w-64 md:w-full z-40 md:z-auto transition-transform md:transition-none ${
          ...
          <li>
            <button
              ...
              className={`text-left w-full p-2 rounded transition ${
                !selectedCategory ? 'bg-primary text-white font-bold' : 'hover:bg-gray-100'
              }`}
            >
              All Products
            </button>
